...
export default async function SpecialtiesPage({
  ...
  const detailsMap: Record<string, string[]> = {
		ar: [
			...
			"تعتبر روسيا من أكثر الدول تقدماً في جراحة العظام وتركيب المفاصل الصناعية بالروبوت. تُستخدم أحدث تقنيات الحد الأدنى من الجراحة بأسعار تنافسية مقارنة بأوروبا.",
			...
			"تقدم روسيا برامج إعادة تأهيل متطورة بعد الجلطات الدماغية والعمليات الجراحية، مع توفير الأطراف الصناعية بالروبوت الحديثة وفرق إعادة تأهيل متخصصة.",
		],
		en: [
